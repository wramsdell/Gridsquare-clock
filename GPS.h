...
class GPSDateTime {
 public:
  ...
  char *getMaidenhead() {return get_mh(latitude,longitude,6); };
 ...
 private:
  ...
  bool isNotChecked;
  enum {waitDollar, getType, inTimeCode, inGGA, inGSA, inGSV} validCode;
  bool validString;
  bool isUpdated_;
  bool getFlag_;
  bool sawGSV;
  ...
  float pdop, hdop, vdop, latitude, longitude;
